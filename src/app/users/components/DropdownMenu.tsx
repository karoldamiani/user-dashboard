...
export default function DropdownMenu({ onEdit, onDelete }: DropdownMenuProps) {
  return (
    <div className="absolute right-0 top-10 z-20 w-32 bg-gray-800 border border-gray-700 rounded-lg shadow-lg">
      <ul className="py-1">
        <li>
          <button
            onClick={onEdit}
            ...
            >
              <path
                ...
                d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 
                   2.652 2.652L10.582 16.07a4.5 4.5 
        ...
        <li>
          <button
            onClick={onDelete}
            className="flex items-center gap-2 w-full px-4 py-2 text-sm text-red-400 hover:bg-gray-700 hover:text-red-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
